...
public class Navigation2 extends SubsystemBase {
  ...
  public Navigation2(Drive drive) {
    theDrive = drive;
    nodes[0].up = new edge(nodes[0], nodes[2], new Rotation2d(0), 3);
    nodes[0].left = new edge(nodes[0], nodes[1], new Rotation2d(Math.PI / 2), 3);

    nodes[1].up = new edge(nodes[1], nodes[3], new Rotation2d(0), 3);
    nodes[1].right = new edge(nodes[1], nodes[0], new Rotation2d(3 * Math.PI / 2), 3);

    nodes[2].up = new edge(nodes[2], nodes[4], new Rotation2d(0), 3);
    nodes[2].left = new edge(nodes[2], nodes[3], new Rotation2d(Math.PI / 2), 3);
    nodes[2].down = new edge(nodes[2], nodes[0], new Rotation2d(Math.PI), 3);

    nodes[3].up = new edge(nodes[3], nodes[5], new Rotation2d(0), 3);
    nodes[3].right = new edge(nodes[3], nodes[2], new Rotation2d(3 * Math.PI / 2), 3);
    nodes[3].down = new edge(nodes[3], nodes[1], new Rotation2d(Math.PI), 3);

    nodes[4].up = new edge(nodes[4], nodes[6], new Rotation2d(0), 3);
    nodes[4].left = new edge(nodes[4], nodes[5], new Rotation2d(Math.PI / 2), 3);
    nodes[4].down = new edge(nodes[4], nodes[2], new Rotation2d(Math.PI), 3);

    nodes[5].up = new edge(nodes[5], nodes[7], new Rotation2d(0), 3);
    nodes[5].right = new edge(nodes[5], nodes[4], new Rotation2d(3 * Math.PI / 2), 3);
    nodes[5].down = new edge(nodes[5], nodes[3], new Rotation2d(Math.PI), 3);

    nodes[6].left = new edge(nodes[6], nodes[7], new Rotation2d(Math.PI / 2), 3);
    nodes[6].down = new edge(nodes[6], nodes[4], new Rotation2d(Math.PI), 3);

    nodes[7].right = new edge(nodes[7], nodes[6], new Rotation2d(3 * Math.PI / 2), 3);
    nodes[7].down = new edge(nodes[7], nodes[5], new Rotation2d(Math.PI), 3);
  }
    ...
    if (currentEdgeList.size() < 2) {
      ...
      waypoints =
          PathPlannerPath.waypointsFromPoses(
              currentEdgeList.stream().map(n -> n.m_end.m_pose).collect(Collectors.toList()));
  ...
  public Command navUp(Pose2dSupplier robotPose) {
    return Commands.runOnce(
        () -> {
          node selNode;
          if (thePath == null || thePath.isFinished()) {
  ...
  public void periodic() {
    if (thePath != null) {
      Logger.recordOutput("Guidance/interruptible", thePath.getInterruptionBehavior());
    }
    if (thePath != null && thePath.isFinished()) {
      currentEdgeList.clear();
    }
