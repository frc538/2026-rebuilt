...
public class IntakeIOSpark implements IntakeIO {
  ...
  private final SparkFlex movementMotor =
      new SparkFlex(Constants.Intake.MovMotorCanId, MotorType.kBrushless);
  ...
  public IntakeIOSpark() {
    ...
    config
        .encoder
        .positionConversionFactor(radiansPerRotation / 9.0)
        .velocityConversionFactor(radiansPerRotation / 9.0 / 60.0);
