...
public final class Constants {
  ...
  public final class launcherConstants {
    ...
    public static final Pose2d hubBlue = new Pose2d(4.625, 4.030, null);
    public static final Pose2d hubRed = new Pose2d(11.915, 4.030, null);
    public static final Pose2d leftRed = new Pose2d(14.000, 1.7, null);
    public static final Pose2d rightRed = new Pose2d(14.000, 6.250, null);
    public static final Pose2d leftBlue = new Pose2d(2.500, 6.250, null);
    public static final Pose2d rightBlue = new Pose2d(2.5000, 1.7, null);
    ...
    public static final double kFuelMomentOfInertia = 2.0 / 5.0 * fuelMass * fuelRadius * fuelRadius;
